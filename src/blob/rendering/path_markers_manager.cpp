...
void PathMarkersManager::drawImpulseMarker(QPainter &painter, const PathMarker &marker, const QPointF &pos,
    const QColor &markerColor, qint64 currentTime) {
...
void PathMarkersManager::drawWaveMarker(QPainter &painter, const PathMarker &marker, const QPointF &pos,
...
void PathMarkersManager::drawQuantumMarker(QPainter &painter, const PathMarker &marker, const QPointF &pos,
    const QColor &markerColor, qint64 currentTime) {
