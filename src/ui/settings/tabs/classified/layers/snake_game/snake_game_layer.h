 ...
 * The goal is to collect 4 apples. After collecting the apples, an exit opens
...
private:
     ...
     * Prevents the snake from reversing a direction directly (e.g., going left immediately after going right).
    ...
    /** @brief The number of apples collected so far. */
    ...
    int parts_exited_;
    /** @brief Store the coordinates considered as valid exit points (just outside the border). */
